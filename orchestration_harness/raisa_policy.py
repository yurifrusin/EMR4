...
# Membership is a fixed catalogue of already reviewed ordinary source paths.
# A repair binding selects at most six; membership never authorizes observation.
G2_CATALOGUE_SOURCE_BINDING_SHA256 = "7e89982ca3da1309a4cd89a3b2867e881d7e6ce709d9abce051440c6528cf923"
G2_CATALOGUE_PATH_SET_SHA256 = "06014ca4dbf1468180cfa52ab10c1630cd3772224501b583fd567ae218d8a3ff"
G2_CATALOGUE_PATHS = ('app/__init__.py',
 'app/config.py',
 'app/database.py',
 'app/dependencies.py',
 ...
 'app/models/application_identity_federation.py',
 'app/models/application_identity_oidc_attempt.py',
 'app/models/appointments.py',
 'app/models/base.py',
 'app/models/bernie_sessions.py',
 'app/models/billing.py',
 'app/models/care_plans.py',
 ...
 'app/models/practice_administration_commands.py',
 'app/models/rag.py',
 ...
 'app/routers/practice_administration.py',
 'app/routers/search.py',
 'app/schemas/__init__.py',
 'app/schemas/application_auth_transport.py',
 'app/schemas/application_identity_oidc_transport.py',
 'app/schemas/appointments.py',
 'app/schemas/auth.py',
 'app/schemas/clinical.py',
 'app/schemas/diary.py',
 'app/schemas/diary_events.py',
 'app/schemas/patients.py',
 'app/schemas/practice.py',
 'app/schemas/practice_administration_default_location_command.py',
 'app/services/__init__.py',
 'app/services/ai/__init__.py',
 'app/services/ai/access_service.py',
 'app/services/ai/audit_events.py',
 'app/services/ai/audit_store.py',
 'app/services/ai/contracts.py',
 'app/services/ai/costing.py',
 'app/services/ai/entitlements.py',
 ...
 'app/services/application_auth_transport.py',
 ...
 'app/services/bernie/action_grammar.py',
 'app/services/bernie/capabilities.py',
 'app/services/bernie/confirm_gate.py',
 'app/services/bernie/context.py',
 'app/services/bernie/evidence.py',
 'app/services/bernie/frames.py',
 'app/services/bernie/interpreter.py',
 'app/services/bernie/language_normalization.py',
 'app/services/bernie/normalizer.py',
 'app/services/bernie/pilot.py',
 'app/services/bernie/policy.py',
 'app/services/bernie/schedule_explanations.py',
 'app/services/bernie/semantic_extraction.py',
 'app/services/bernie/session.py',
 'app/services/bernie/session_store.py',
 'app/services/bernie/temporal.py',
 'app/services/bernie/transitions.py',
 'app/services/bernie/ui_view_model.py',
 'app/services/bernie_booking_classifier.py',
 'app/services/bernie_booking_interpreter.py',
 'app/services/bernie_patient_context.py',
 'app/services/bernie_pilot_gate.py',
 'app/services/bernie_slot_normalizer.py',
 'app/services/bernie_transition_table.py',
 'app/services/bernie_turn_evidence.py',
 'app/services/diary/__init__.py',
 'app/services/diary/action_grammar.py',
 'app/services/diary/capabilities.py',
...
def g2_catalogue_profile() -> dict:
    profile = g2_batch_profile()
    profile.update(scope_behavior='bounded_g2_catalogue_repair_batches',
                   allowed_paths=list(G2_CATALOGUE_PATHS))
    return profile
