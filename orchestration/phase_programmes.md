...
| Item | Value |
|---|---|
| Status | Sprint 159 Bernie tool-intent update-confirm client header emission completed; sprint engine continuing |
...
The default recommendation after Sprint 159 is **Programme 2G**: Sprint 160
should prepare the Bernie/Diary review-readiness packet and pause for Yuri if
the readiness checks pass. Proposal-only backend binding and strict
`minLength: 8` enforcement remain deferred behind that review path. Preserve
backend ledger semantics, raw compatibility writes, providers, GraphQL,
