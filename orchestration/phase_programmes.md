...
| Item | Value |
|---|---|
| Status | Sprint 141 update-confirm idempotency route wiring completed; sprint engine continuing |
...
Current position after Sprint 141: the Ariadne/Fable 100+ sprint strategy map
...
delete/raw/proposal-only families out of scope.
...
1. If Bernie/API-spine architecture is the priority: continue **Programme 2G**
   with delete-confirm idempotency preflight before touching the destructive
   soft-cancel confirmation path, excluding raw/proposal-only families.
...
The default recommendation after Sprint 141 is **Programme 2G**: preflight
delete-confirm idempotency before any delete-confirm route wiring, and
