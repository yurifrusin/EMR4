...
| Item | Value |
|---|---|
| Status | Sprint 144 delete-confirm idempotency route wiring completed; sprint engine continuing |
...
Current position after Sprint 144: the Ariadne/Fable 100+ sprint strategy map
...
GraphQL/H15/memory/trove gates.
...
The default recommendation after Sprint 144 is **Programme 2G**: run an
appointment idempotency confirmation-family checkpoint/audit before deciding
whether to touch proposal-only routes or broader command surfaces, and
