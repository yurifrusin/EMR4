...
| Item | Value |
|---|---|
| Status | Sprint 129 appointment idempotency storage helper foundation completed; route integration preflight selected next |
...
Current position after Sprint 129: the Ariadne/Fable 100+ sprint strategy map
...
1. If Bernie/API-spine architecture is the priority: continue **Programme 2G**
   with appointment idempotency route integration preflight, keeping first route
   wiring narrow and reviewed around one confirm family.
...
The default recommendation after Sprint 129 is **Programme 2G**: add
appointment idempotency route integration preflight before expanding Caller ID,
