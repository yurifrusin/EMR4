...
| Item | Value |
|---|---|
| Status | Sprint 145 appointment idempotency confirmation-family checkpoint completed; sprint engine continuing |
...
Current position after Sprint 145: the Ariadne/Fable 100+ sprint strategy map
...
The default recommendation after Sprint 145 is **Programme 2G**: add
cross-family route-level idempotency integration tests across all five wired
confirmation families before deciding whether to touch proposal-only routes or
broader command surfaces, and
