...
| Next Candidate Sprints | Audio scribe and letter drafting migration through Access AI, or push/realign the local Access AI batch |
...
1. If AI platform safety is the priority: continue **Programme 2F** by routing
   the remaining Copilot AI paths through Access AI, or pause to push and
   realign the local Access AI batch.
