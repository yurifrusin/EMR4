...
| Item | Value |
|---|---|
| Status | Sprint 150 create-proposal syntactic idempotency wiring completed; sprint engine continuing |
...
Current position after Sprint 150: the Ariadne/Fable 100+ sprint strategy map
...
The default recommendation after Sprint 150 is **Programme 2G**: add an
OpenAPI/FastAPI header alignment guard for create-proposal, including the
currently deferred `minLength: 8` decision and a client-readiness note, before
expanding idempotency enforcement to update/status/waiting-area/delete proposal
routes.
