...
| Item | Value |
|---|---|
| Status | Sprint 154 diary/API header-gap preflight completed; sprint engine continuing |
...
Current position after Sprint 154: the Ariadne/Fable 100+ sprint strategy map
...
The default recommendation after Sprint 154 is **Programme 2G**: Sprint 155
should wire create-confirm and confirm-Bernie client header emission first,
using a stable per-proposal confirm key so retries exercise the existing
confirmation ledger replay path. Do not change backend runtime enforcement,
ledger semantics, raw compatibility writes, providers, GraphQL, H15/H-series,
memory/RAG/GraphRAG, or strict `minLength: 8` enforcement in that slice.
