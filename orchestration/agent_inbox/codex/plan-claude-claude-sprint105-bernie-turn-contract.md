...
- Review result: Accepted for implementation; backend/API typed turn refs, freshness evidence, and confirm staleness gate were in scope.
- Required changes before implementation: Keep all new fields additive/backward compatible and preserve staff-confirmation gating.
