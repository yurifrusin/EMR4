# Independent veto: behavior attempt 047 rollback-gap fixture recovery
...
`C:\Users\sarashera\EMR4-worktrees\raisa-context-fabric-durability-behavior-r180`
at exact `3e73606a0b451d02d2bb3d4d9d22eee161aa084f`, predecessor
`5f4067340be0958612b0dad351222f32f13900d1`. Protected refs remain exact
`2e34bdad732fdab32fbf778280b3d3c70d66d602`.

Perform complete five-source AGENTS.md rehydration. Review only AGENTS.md;
exact diff `5f4067340be0958612b0dad351222f32f13900d1..3e73606a0b451d02d2bb3d4d9d22eee161aa084f`;
the immutable attempt-047 failure evidence; the diagnosis note/script/test;
the behavior contract/harness/test; the AER-0237 register update; and the
tracked exact parent evidence and generated artifact files required to
reconcile their hashes. Do not inspect mutable evidence aliases, holdouts,
...
2. immutable attempt-047 evidence SHA-256
   `bc577de88b7acafac72828bb2ddae898181886d08676c8802acf84ef925ebd63`,
   attempt `2be135bb50da12e457e64eb6`, BTR-B03 expected `P0001`, observed
   `22012`, and exact cleanup of container
   `4ff69a925106cf9d14c929d76173067d04feb4580e173e7c6d3c3240c8a7b2cc`;
3. the causal diagnosis: a checkpoint at zero plus a fixture starting at
   position two correctly selects the contract's gap-rebase path before the
   deliberately injected rollback, so the harness assertion—not the generated
   database artifact—caused the unexpected divide-by-zero SQLSTATE;
4. the repair changes only BTR-B03's precondition, transition, and probe from
   source position two to one, making the fixture contiguous and preserving the
   intended post-mutation `P0001` rollback observation;
5. canonical behavior contract remains exact SHA-256
   `43b25bd7509439f069643dcb0ae8e62e27002834fe9903d84e7478486b452615`;
   its twenty scenarios, order, expected outcomes, SQLSTATEs and category counts
   `6/4/3/4/3` are unchanged;
6. inert SQL and manifest remain exact SHA-256
...
7. AER-0237 truthfully records a closed harness/fixture incident without
   widening product or runtime claims;
...
git diff --check 5f4067340be0958612b0dad351222f32f13900d1..3e73606a0b451d02d2bb3d4d9d22eee161aa084f
