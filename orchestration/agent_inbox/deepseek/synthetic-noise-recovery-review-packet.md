# DeepSeek Synthetic Noise Recovery Review Packet

Date: 2026-07-17

## Binding

- Worktree: `C:\Users\sarashera\EMR4-worktrees\synthetic-noise-deepseek-review`
- Branch: `codex/synthetic-noise-deepseek-review`
...
- natural receptionist-to-Bernie staff instruction, not patient dialogue;
...
listing 192 accepted IDs. A single semantic contradiction requires
`revision_required`.
...
- `orchestration/agent_inbox/deepseek/synthetic-noise-recovery-review.md`
