# DeepSeek Synthetic Noise Generation Packet

Date: 2026-07-17

## Binding

- Worktree: `C:\Users\sarashera\EMR4-worktrees\synthetic-noise-deepseek`
- Branch: `codex/synthetic-noise-deepseek`
...
Create a deterministic DeepSeek-specific generator and exactly 192 JSONL
...
only. Do not change, infer, repair, or duplicate an oracle. The output should
show varied receptionist-to-Bernie staff language rather than patient calls,
clinical dialogue, or generic assistant prose.

## Owned files

- `app/services/bernie/synthetic_noise_deepseek.py`
- `tests/fixtures/bernie_synthetic_noise/candidates_deepseek.jsonl`
- `orchestration/agent_inbox/deepseek/synthetic-noise-generation-completion.md`
...
- exact generator identity `deepseek/deepseek-v4-flash/synthetic-noise-deepseek`;
...
C:\Users\sarashera\emr4\.venv\Scripts\python.exe -m py_compile app\services\bernie\synthetic_noise_deepseek.py
C:\Users\sarashera\emr4\.venv\Scripts\python.exe app\services\bernie\synthetic_noise_deepseek.py --check
git diff --check
```
