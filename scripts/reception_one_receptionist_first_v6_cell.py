#!/usr/bin/env python3
"""Credential-free fixture cell for one receptionist-first v6 turn."""
...
def run() -> dict[str, Any]:
    ...
    if (
        ...
        != "reception.one.bureau.receptionist-first.v6"
    ...
    return {
        "schema_version": (
            "reception.one.receptionist_first_v6.fixture_cell_result.v1"
        ),
        "status": "completed",
        "turn_code": turn_code,
