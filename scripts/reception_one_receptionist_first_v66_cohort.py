#!/usr/bin/env python3
"""Run the full 24-case receptionist-first v6.6 cohort."""
...
OCCUPIED_RESULT_PASS = (
    "reception_one_receptionist_first_v66_full_cohort_pass"
)
OCCUPIED_RESULT_FAIL = (
    "reception_one_receptionist_first_v66_full_cohort_fail_closed"
)


class V66CohortError(RuntimeError):
    """A v6.6 cohort contract, lifecycle or audit rejection."""
...
def build_provider_blocked_evidence(
    *,
    ...
    if (
        ...
        raise V66CohortError("v66_provider_blocked_boundary_invalid")
    return evidence
...
def run_occupied(
    *,
    ...
    if (
        ...
        raise V66CohortError("v66_occupied_boundary_invalid")
    return evidence
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "result": (
                        "reception_one_receptionist_first_v66_blocked"
                    ),
