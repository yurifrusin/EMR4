#!/usr/bin/env python3
"""Run the full 24-case receptionist-first v6.3 form-toolkit cohort."""
...
OCCUPIED_RESULT_PASS = (
    "reception_one_receptionist_first_v63_full_cohort_pass"
)
...
class V63CohortError(RuntimeError):
    """A v6.3 cohort contract, lifecycle or audit rejection."""
...
def build_provider_blocked_evidence(
    *,
    ...
    if (
        ...
        raise V63CohortError("v63_provider_blocked_boundary_invalid")
    return evidence
...
def run_occupied(
    *,
    ...
    if (
        ...
        raise V63CohortError("v63_occupied_boundary_invalid")
    return evidence
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "result": (
                        "reception_one_receptionist_first_v63_blocked"
                    ),
