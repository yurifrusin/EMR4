#!/usr/bin/env python3
"""Credential-free fixture cell for one receptionist-first v6.1 turn."""
...
def run() -> dict[str, Any]:
    ...
    if (
        ...
        != "reception.one.bureau.receptionist-first.v6.1"
    ...
    return {
        "schema_version": (
            "reception.one.receptionist_first_v61.fixture_cell_result.v1"
        ),
        "status": "completed",
        "turn_code": turn_code,
