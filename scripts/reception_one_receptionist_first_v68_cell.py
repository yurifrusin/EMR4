#!/usr/bin/env python3
"""Credential-free fixture cell for one receptionist-first v6.8 turn."""
...
def run() -> dict[str, Any]:
    ...
    try:
        ...
        if error.errno != errno.EROFS:
            raise CellError("root_filesystem_not_read_only") from error
    else:
    ...
    if (
        ...
        != "reception.one.bureau.receptionist-first.v6.8"
    ...
    if turn.get("bureau_packet") != {
        ...
        raise CellError("bureau_packet_boundary_invalid")
    ...
    return {
        "schema_version": (
            "reception.one.receptionist_first_v68.fixture_cell_result.v1"
        ),
        "status": "completed",
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": (
                        "reception.one.receptionist_first_v68."
