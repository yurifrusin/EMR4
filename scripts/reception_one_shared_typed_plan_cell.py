#!/usr/bin/env python3
"""Credential-free provider-free PlanProgram fixture cell."""
...
def run() -> dict[str, Any]:
    ...
    if (
        ...
        != "reception.one.bureau.shared-model-input.v3"
    ...
    return {
        "schema_version": "reception.one.shared_typed.fixture_cell_result.v1",
        "status": "completed",
        "program": program,
        "isolation": {
            "uid": os.getuid(),
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": (
                        "reception.one.shared_typed.fixture_cell_result.v1"
                    ),
                    "status": "edge_aborted",
                },
                sort_keys=True,
