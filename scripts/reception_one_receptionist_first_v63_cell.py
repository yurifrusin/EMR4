#!/usr/bin/env python3
"""Credential-free fixture cell for one receptionist-first v6.3 turn."""
...
def run() -> dict[str, Any]:
    ...
    if (
        ...
        != "reception.one.bureau.receptionist-first.v6.3"
    ...
    return {
        "schema_version": (
            "reception.one.receptionist_first_v63.fixture_cell_result.v1"
        ),
        "status": "completed",
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": (
                        "reception.one.receptionist_first_v63."
