#!/usr/bin/env python3
"""Credential-free fixture cell for one proofreader-dialogue turn."""
...
PROGRAM_PATH = ROOT / "plan-program.json"
...
def run() -> dict[str, Any]:
    ...
    if (
        ...
        != "reception.one.bureau.proofreader-dialogue.v4"
    ...
    return {
        "schema_version": (
            "reception.one.proofreader_dialogue_v4.fixture_cell_result.v1"
        ),
        "status": "completed",
        "turn_code": turn_code,
