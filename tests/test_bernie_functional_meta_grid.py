...
def test_functional_meta_grid_files_are_wired_into_the_existing_diary():
    ...
    assert '<link rel="stylesheet" href="meta-grid.css?v=13"' in html
    assert '<script src="diary.js?v=201" defer>' in html
    assert '<script src="meta-grid.js?v=18" defer>' in html
