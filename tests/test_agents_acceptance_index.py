...
def test_acceptance_index_matches_hash_bound_manifest() -> None:
    ...
    assert manifest["source_git_head"] == ("c96128adcc3b43ade8f7f1d13da693df2760c551")
    assert manifest["source_agents_sha256"] == (
        "0e9598c7cce4ae7bd6191d298022919445761e4178753c9148743a8d05834490"
    )
    assert manifest["source_agents_byte_count"] == 78666
    assert manifest["source_agents_line_count"] == 413
    ...
    assert len(ledger_labels) == manifest["moved_row_count"] == 222
