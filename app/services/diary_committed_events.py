...
from app.schemas.diary_events import (
    AppointmentCheckedInEventPayload,
...
def record_appointment_checked_in_event(
    db: Session,
    *,
    appointment: Appointment,
    audit: AppointmentAuditLog,
    ...
    command_id: uuid.UUID,
    status_before: str,
    waiting_area_id_before: uuid.UUID | None,
    waiting_area_id_after: uuid.UUID | None,
    occurred_at: datetime | None = None,
) -> DiaryCommittedEvent:
    """Append the one authorized check-in event inside the caller's transaction."""
    ...
    payload = AppointmentCheckedInEventPayload(
        appointment_id=appointment.id,
        practitioner_id=appointment.practitioner_id,
        location_id=appointment.location_id,
        status_before=status_before,
        status_after="Arrived",
        waiting_area_id_before=waiting_area_id_before,
        waiting_area_id_after=waiting_area_id_after,
