...
| Ariadne agent error and correction register acceptance | Current revision 309: `docs/ariadne-agent-error-correction-register-revision-309.md`. The register contains 356 bounded known incidents, all corrected or explicitly contained. AER-0354 and recurrent AER-0356 require full Git object IDs in continuation evidence to become machine-resolved or mechanically compared rather than manually completed. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. Controls: `scripts/ariadne_agent_error_register.py`, `scripts/ariadne_serial_pytest.py`, `scripts/ariadne_verifier_worktree_preflight.py`, `scripts/compact_agents_acceptance_index.py`, `tests/test_ariadne_agent_error_register.py`, `tests/test_agents_acceptance_index.py` and `docs/ariadne-agent-error-correction-register-closeout.md`. |
