...
| Ariadne agent error and correction register acceptance | Current revision 329: `docs/ariadne-agent-error-correction-register-revision-329.md`; 378 bounded incidents, all corrected or contained. AER-0369 through AER-0378 preserve the product-seam, worker-scope, Docker-profile, probe-shape, Git-ref and pytest-envelope incidents exposed during HTTP/PostgreSQL integration. The authorised post-closeout effectiveness review will use them as evidence for narrow workflow repairs. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. |
