...
| Ariadne agent error and correction register acceptance | Revision 393: `docs/ariadne-agent-error-correction-register-revision-393.md`; 451 bounded incidents, all corrected/contained and none open. AER-0451 preserves and corrects the successor preplanning continuation-event vocabulary mismatch before any dispatch or provider request. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. |
