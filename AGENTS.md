...
| Ariadne agent error and correction register acceptance | Revision 608: `docs/ariadne-agent-error-correction-register-revision-608.md`; 907 bounded incidents, all corrected/contained and none open. AER-0898 through AER-0903 record and correct the preexecution orchestration lapses. AER-0904 and AER-0905 bind the material schema-token and contradictory-envelope controller defects plus the zero-process offline recovery. AER-0906 and AER-0907 record the commit-gate and closed-vocabulary corrections. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. |
