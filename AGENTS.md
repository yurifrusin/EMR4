...
| Ariadne agent error and correction register acceptance | Current revision 330: `docs/ariadne-agent-error-correction-register-revision-330.md`; 379 bounded incidents, all corrected or contained. AER-0369 through AER-0378 preserve the product-seam, worker-scope, Docker-profile, probe-shape, Git-ref and pytest-envelope incidents used by the active effectiveness review. AER-0379 preserves its correctly stopped canonical run and the compacted pre-existing live-handover overrun. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. |
