...
| **Current active track** | Sprint 25 - Programme 2B status/waiting-area proposal retrofit closed |
| **Next recommended work** | Continue Programme 2B with the next safe appointment-mutation slice if no Yuri-only review remains |
