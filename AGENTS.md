...
| **Current active track** | Sprint R13 Diary smoke harness recovery closed; Sprint R14 auth bootstrap guard recommended next |
| **Next recommended work** | Sprint R14: auth bootstrap harness guard or reason-code UX polish after checking Claude availability at sprint start |
