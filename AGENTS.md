...
| **Current active track** | Sprint R24 provider-readiness dry-run gate closed cleanly |
| **Next recommended work** | Sprint R25 no-write live-provider sampling harness only if config/tooling is ready |
