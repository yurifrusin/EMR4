...
| Active product track | LC4V10 fresh certification passed; synthetic Silver v2 remains complete. T3R6 accepts a separate Vertex `us` synthetic-development trust zone from 2026-10-16 while preserving Australian production/PII gating for a fresh review no earlier than 2027; no provider call or cloud mutation is authorized and mandatory Pushover closeout pings remain restored |
| Active acceptance | `orchestration/agent_inbox/codex/lc4v10-sol-acceptance.md`, `docs/bernie-lc4v10-fresh-certification-closeout.md`, `orchestration/agent_inbox/codex/security-hardening-final-purple-acceptance.md`, `docs/security/secure-sdlc-red-blue-diary-hardening-closeout-2026-07-17.md`, `docs/bernie-post-certification-transition-review.md`, `orchestration/agent_inbox/codex/appointment-call-quarantine-pilot-sol-acceptance.md`, `docs/bernie-appointment-call-quarantine-pilot-closeout.md`, `docs/bernie-synthetic-silver-v2-anchor-contract.md`, `docs/bernie-synthetic-silver-v2-closeout.md`, `orchestration/agent_inbox/antigravity/synthetic-silver-v2-final-review.md`, `orchestration/agent_inbox/codex/synthetic-silver-v2-sol-acceptance.md`, `docs/bernie-t3r1-synthetic-shadow-refresh.md`, `docs/bernie-t3r1-synthetic-shadow-baseline.json`, `orchestration/agent_inbox/codex/t3r1-synthetic-shadow-refresh-sol-acceptance.md`, `docs/bernie-t3r2-synthetic-live-comparison-approval.json`, `docs/bernie-t3r3-three-lane-transport-preflight-closeout.md`, `docs/bernie-t3r4-pragmatic-live-comparison-approval.json`, `docs/bernie-t3r4-pragmatic-live-comparison-report.json`, `docs/bernie-t3r4-pragmatic-live-comparison-closeout.md`, `orchestration/agent_inbox/codex/t3r4-pragmatic-live-comparison-sol-acceptance.md`, `docs/bernie-t3r5-vertex-au-feasibility-and-entitlement-design.md`, `docs/bernie-t3r5-vertex-au-readiness-report.json`, `docs/bernie-t3r5-vertex-au-feasibility-closeout.md`, `orchestration/agent_inbox/codex/t3r5-vertex-au-feasibility-sol-acceptance.md`, `docs/bernie-t3r6-us-synthetic-development-policy.md`, `docs/bernie-t3r6-us-synthetic-development-report.json`, `docs/bernie-t3r6-us-synthetic-development-closeout.md`, and `orchestration/agent_inbox/codex/t3r6-us-synthetic-development-sol-acceptance.md` |
| Current result | V10 remains a valid bounded `certification_pass`: complete and every dimension 576/576; synthetic Silver v2 remains 192/192. T3R4 validly closed `comparison_complete_with_hard_limit_stop` and remains bounded evidence; T3R5 remains valid historical no-call evidence. T3R6 returns `us_synthetic_development_path_scheduled_not_call_ready`: Gemini 3.5 Flash satisfies the US model/location/runway criterion, but the transition date and entitlement/retention/audit/cost controls still fail closed; no model call, PII authority, production authority, or cloud mutation moved |
| Next implementation | No V11 is needed or authorized, and no synthetic v3 is authorized. After 2026-10-16, rerun the no-call US synthetic-development readiness only when the entitlement/retention/audit/cost controls are ready; a passing report still requires a new exact-model/prompt/budget provider-call decision. Production/PII remains Australian-gated for fresh review no earlier than 2027; product runtime, API/database/UI, confirmation, deployment/release, and write authority remain closed |
...
### T3R5-T3R6 accepted state
T3R5 established that no long-lived current Gemini successor was available in Sydney and closed `blocked_before_provider_call`. Yuri then distinguished synthetic development from future production/PII residency: from 2026-10-16, location-controlled Vertex `us` is acceptable for deliberately synthetic development, while production or PII remains Australian-gated for fresh review no earlier than 2027. Gemini 3.5 Flash satisfies the documentary US model/location/runway criterion.
T3R6 is `us_synthetic_development_path_scheduled_not_call_ready`: transition date, Vertex/billing, IAM, regional pin/fallback denial, audit/logging/retention, and hard cost controls remain closed. No model call, cloud mutation, content transmission, product runtime, route, database, appointment, confirmation, deployment, release, PII, production, or write authority moved. Even a passing report requires a new exact-model/prompt/budget decision.
...
T3.1-T3.4 remain intact and blocked by default. The dedicated T3R4 synthetic evaluation exception is consumed and closed. T3R5 remains historical no-call evidence. T3R6 authorizes a US synthetic-development policy from 2026-10-16 but no provider call, prompt transmission, cost acceptance, runtime, PII, or production authority. T3.5 adapters, further live calls/external prompts, raw-response persistence, provider-executed tools, promotion claims, and runtime wiring remain deferred.
