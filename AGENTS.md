...
| Ariadne agent error and correction register acceptance | Revision 392: `docs/ariadne-agent-error-correction-register-revision-392.md`; 450 bounded incidents, all corrected/contained and none open. AER-0446 through AER-0450 preserve and correct the broader native-Harness rehearsal's shell composition, long-process handle, named permission preset, foreign Git object and pre-forward request-accounting incidents. Durable state: `orchestration/continuity/ariadne-agent-error-register/`. |
