...
| Next implementation | Freeze Bureau C5's narrowest disposable non-PHI live-development-recovery plan under standing programme authority. Planning must bind one isolated synthetic target and reversible injected fault, the exact provider/model/region/identity/data/cost/call and positive-reasoning envelope, deterministic proofreader and authority policy, human approval, rollback, fresh readback, audit and cleanup. C4 grants no live action. Do not proceed to an occupied/provider or actuator action until C5's own plan, deterministic and independent gates admit it. Patient/product/protected data, real practice databases, ordinary services, production, deployment, release, Pages, protected evidence and protected-ref movement remain closed. Preserve and exclude `docs/branding/` and all existing Consultant/Gate-minus-one/A3-B3/A4 receipt/state files. |
