...
| **Current active track** | Sprint 159 Bernie tool-intent update-confirm client header emission implemented in commit `710e1b9`; the last known enforced confirm-client header gap is closed |
