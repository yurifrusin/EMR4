...
| **Current active track** | Sprint 37 - appointment audit warning-summary persistence and diary read-only warning display closed |
| **Next recommended work** | Continue with the next recommended sprint unless Yuri input is needed |
